  ...
  <UButton
    ...
    :ui="{
      color: {
        gray: {
          solid:
            'ring-0 border border-gray-700 border-dashed hover:border-solid bg-transparent dark:bg-transparent text-gray-600 dark:text-gray-400 hover:bg-transparent dark:hover:bg-transparent',
        },
        green: {
          solid:
            'ring-0 border-2 border-green-400 bg-transparent dark:bg-transparent text-green-600 dark:text-green-400 hover:bg-transparent dark:hover:bg-transparent',
        },
      },
    }"
